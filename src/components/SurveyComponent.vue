...
import { QBtn, QIcon, QInput, QSlider, QCarousel, QCarouselSlide, QBtnGroup, QSpinnerOval,QDatetime,QAlert,date,QBtnToggle,QDialog,QSelect,Dialog,QCollapsible, QCard,QCardTitle, QCardMain,QCardMedia, QCardSeparator, QCardActions  } from 'quasar'
...
export default {
  ...
  components: { QBtn, QIcon, QInput, QSlider, QCarousel, QCarouselSlide, QBtnGroup, QSpinnerOval,QDatetime,QDatetime,QDialog,QSelect,Dialog,QCollapsible,QCard,QCardTitle, QCardMain,QCardMedia,QCardSeparator,QCardActions,SurveyVue },
  ...
  console.log("in mounted")
   ...
   vm.surveyJSON = {
    ...
    },
    {
      ...
      "name": "two",
      "isRequired": true,
      "title": "How likely are you to recommend this service to your friends and family?",
      ...
      vm.survey
        ...
        document
            .querySelector('#surveyResult')
             ...
             var TransactionDate = moment(currentDate).format('YYYY-MM-DDTHH:mm:ss.SSSZ')
              ...
              for(var i=1;i<=vm.surveyJSON.questions.length;i++){
                 ...
                 switch(i) {
                    case 1:
                      ...
                      console.log("q"+i+" = "+vm.surveyJSON.questions[vm.questIndex].title)
...
.sv_q_complete_btn:hover, .sv_q_complete_btn:focus {
  color: white;
  opacity: 0.8;
}
</style>
